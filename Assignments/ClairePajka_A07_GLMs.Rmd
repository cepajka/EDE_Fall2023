...
It shows that on average, Crampton Lake ha a higher temperature than Tuesday or Ward Lake at the same depth. 
...
> Answer:
The r^2 explains how much variability is explained by depth, so the r^2 value of 0.7387 means that 73.87% of the variability is accounted for by depth. The degrees of freedom are 9724. p value is less than 2.2e-16.
