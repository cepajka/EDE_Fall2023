...
GaringerOzone.monthly <-
  ...
  group_by(Daily.Max.8.hour.Ozone.Concentration, Date) %>%
...
GaringerOzone.daily.ts <- ts(GaringerOzone_clean$Daily.Max.8.hour.Ozone.Concentration, start=c(f_year, f_month, frequency=12))
...
```{r}
#11
dailyozone_decomp <- decompose(GaringerOzone.daily.ts)
plot(dailyozone_decomp)

monthlyozone_decomp <- stl(GaringerOzone.monthly.ts, s.window =12)
