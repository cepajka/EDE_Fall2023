...
GaringerOzone.monthly <-
  ...
  group_by(Year, Month) %>%
  summarise(Daily.Max.8.hour.Ozone.Concentration = mean(Daily.Max.8.hour.Ozone.Concentration$Month)) %>%
  mutate(Date = as.Date(paste(Year, Month, "01"), format = "%Y/%B/%d")) %>%
  mutate(Average = mean(Daily.Max.8.hour.Ozone.Concentration))
