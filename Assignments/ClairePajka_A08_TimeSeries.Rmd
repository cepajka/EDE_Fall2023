...
view(ozone_no_seasonal)

#not sure I need anything below this
#f_month <- month(first(GaringerOzone.monthly$Date))
#f_year <- year(first(GaringerOzone.monthly$Date))
#ozone_no_seasonal.ts <- ts(ozone_no_seasonal$MonthlyAverag, frequency=12, start=c(f_year, f_month))
...
Score =  -16300 , Var(Score) = 1545533, denominator =  28680
