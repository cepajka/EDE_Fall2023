...
#5 
Monthly_temp_plot <-
  ggplot(Lake_Chemistry_Nutrients_PeterPaul_Processed, aes(x=month, y = temperature_C))+
...
#scale_x_date(limits = month(c("5", "10")), 
...
Monthly_Tp_plot <-
  ggplot(Lake_Chemistry_Nutrients_PeterPaul_Processed, aes(x=month, y = tp_ug))+
  geom_boxplot(aes(color = lakename))+
...
Monthly_Tn_plot <-
  ggplot(Lake_Chemistry_Nutrients_PeterPaul_Processed, aes(x=month, y = tn_ug))+
  geom_boxplot(aes(color = lakename))+
