...
#4
EPAair_O3_NC2018_processed <- select(EPAair_O3_NC2018_raw, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
summary(EPAair_O3_NC2018_processed)
EPAair_O3_NC2019_processed <- select(EPAair_O3_NC2019_raw, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
summary(EPAair_O3_NC2019_processed)
EPAair_PM25_NC2018_processed <- select(EPAair_PM25_NC2018_raw, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
summary(EPAair_PM25_NC2018_processed)
EPAair_PM25_NC2019_processed <- select(EPAair_PM25_NC2019_raw, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
EPAair_combined <- rbind(EPAair_O3_NC2018_processed, EPAair_O3_NC2019_processed, EPAair_PM25_NC2018_processed, EPAair_PM25_NC2019_processed)
...
#9
EPAair_combined_pipe_spread <- pivot_wider(EPAair_combined_pipe, names_from = AQS_PARAMETER_DESC , values_from = AQImean )
view(EPAair_combined_pipe_spread)
#10
dim(EPAair_combined_pipe_spread)

#11
write.csv(EPAair_combined_pipe_spread, row.names = FALSE, file = "./Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv")
