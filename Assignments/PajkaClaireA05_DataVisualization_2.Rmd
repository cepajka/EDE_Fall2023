...
Lake_Chemistry_Nutrients_PeterPaul_Processed <- read.csv(
  file=here(
    "C:/Users/cepaj/OneDrive/Documents/EDE_Fall2023/Data/Processed_KEY/Processed_KEY/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv"), stringsAsFactors = TRUE)
Lake_ChemistryPhysics_PeterPaul_Processed <- read.csv(
  file=here(
    "C:/Users/cepaj/OneDrive/Documents/EDE_Fall2023/Data/Processed_KEY/Processed_KEY/NTL-LTER_Lake_Nutrients_PeterPaul_Processed.csv"), stringsAsFactors = TRUE)
Litter_mass_trap_processed <- read.csv(
  file=here(
    "C:/Users/cepaj/OneDrive/Documents/EDE_Fall2023/Data/Processed_KEY/Processed_KEY/NEON_NIWO_Litter_mass_trap_Processed.csv"), stringsAsFactors = TRUE)
...
Needlemass_facet <-
  ...
  scale_x_date(name="Collection Date by Year", date_labels ="%Y")+
  theme(axis.text = element_text(size = 10))+
  theme(axis.text.x = element_text(angle = 45, hjust=1))
